...
<html lang="vi">
    <head>
        ...
        <style>
            /* Định nghĩa màu Tím chủ đạo (sử dụng màu Purple của Bootstrap) */
            :root {
                --bs-primary: #6f42c1; /* Màu tím */
            }
            .bg-primary {
            ...
            /* Màu nền footer để có tông tối giống mẫu */
            .footer-dark-bg {
                background-color: #2F4050;
            }
            .bg-warning-custom { /* Đổi màu Vàng nổi bật thành Tím nhạt hơn */
    ...
    <body class="d-flex flex-column min-vh-100 bg-light">
        ...
        <div class="container mt-5 mb-5 flex-grow-1">
            ...
            <div class="row">
                        ...
                        <ul class="pagination justify-content-center">
                            <c:choose>
                                <c:when test="${pageIndex > 1}">
                                    <li class="page-item">
                                        <a class="page-link text-primary" href="home?page=${pageIndex - 1}<c:if test='${selectedCategoryId != null}'>&categoryId=${selectedCategoryId}</c:if>" aria-label="Trang trước">
                            ...
                            <c:forEach begin="1" end="${totalPages}" var="i">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item">
                                            <a class="page-link text-primary" href="home?page=${i}<c:if test='${selectedCategoryId != null}'>&categoryId=${selectedCategoryId}</c:if>">${i}</a>
                                            </li>
                                    </c:otherwise>
                                </c:choose>
                            </c:forEach>
                            ...
                            <c:choose>
                                <c:when test="${pageIndex < totalPages}">
                                    <li class="page-item">
                                        <a class="page-link text-primary" href="home?page=${pageIndex + 1}<c:if test='${selectedCategoryId != null}'>&categoryId=${selectedCategoryId}</c:if>" aria-label="Trang sau">
                ...
                </div> </div> </div> <footer class="mt-auto pt-5 text-white footer-dark-bg">
            <div class="container">
