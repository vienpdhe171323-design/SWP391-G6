...
<head>
    ...
    <title>Hiệu suất cửa hàng - ${storeName}</title>
...
<div class="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <a href="${pageContext.request.contextPath}/store" class="sidebar-item">
...
<div class="main-content">
    <div class="page-header">
        <h2 class="page-title">
            ...
            Hiệu suất cửa hàng: <span style="color:var(--text-light)">${storeName}</span>
        </h2>
        <div class="d-flex gap-2">
            <a href="store?action=list" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="metric-grid">
        ...
        <div class="metric-card" style="border-left-color: #3b82f6;">
            ...
            <div class="metric-value">${performance.totalOrders}</div>
            <div class="metric-label">Tổng đơn hàng</div>
        </div>

        <div class="metric-card" style="border-left-color: #8b5cf6;">
            <div class="metric-icon" style="background: #e9d5ff; color: #6b21a8;">
                <i class="fa-solid fa-boxes-stacked"></i>
            </div>
            <div class="metric-value">${performance.totalProductsSold}</div>
        ...
        <div class="metric-card" style="border-left-color: #f59e0b;">
            ...
            <div class="metric-value">${performance.averageRating}</div>
    ...
    <div class="chart-card">
        <h3 class="chart-title">
            <i class="fa-solid fa-boxes-stacked"></i>Top 5 sản phẩm bán chạy
        </h3>
